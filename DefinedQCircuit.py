...
circuit_img.savefig("DefinedQ_circuit_diagram.png")  # Save the circuit diagram
circuit_img.show()
...
# Plot Bloch spheres for all qubits in a grid
...
fig.savefig("DefinedQ_bloch_spheres.png")  # Save the figure
